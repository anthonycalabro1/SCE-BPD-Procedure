...
export const stages: Stage[] = [
  ...
  {
    id: 2,
    primaryBrdSectionIds: ['1.1', '1.2.1', '1.2.2', '1.3.1', '1.3.4', '1.3.5'],
  ...
  {
    id: 4,
    primaryBrdSectionIds: ['2.1', '1.3.3'],
  ...
  {
    id: 8,
    primaryBrdSectionIds: ['2.2', '2.3', '2.4', '2.5', '2.6', '4.1', '4.2', '4.3', '5.2.1', '5.2.2'],
    ...
    aiPrompts: [
      ...
      {
        id: 'A.8.5',
        title: AI_PROMPTS['A.8.5'].title,
        prompt: AI_PROMPTS['A.8.5'].prompt,
        activity: 'Populate BRD Section 2.3'
      },
      {
        id: 'A.8.6',
        title: AI_PROMPTS['A.8.6'].title,
        prompt: AI_PROMPTS['A.8.6'].prompt,
        activity: 'Populate BRD Section 2.4'
      },
      {
        id: 'A.8.7',
        title: AI_PROMPTS['A.8.7'].title,
        prompt: AI_PROMPTS['A.8.7'].prompt,
        activity: 'Populate BRD Section 2.5'
      },
      {
        id: 'A.8.8',
        title: AI_PROMPTS['A.8.8'].title,
        prompt: AI_PROMPTS['A.8.8'].prompt,
        activity: 'Populate BRD Section 2.6'
      },
      {
        id: 'A.8.2A',
  ...
  {
    id: 11,
    primaryBrdSectionIds: ['4', '5.2.1', '5.2.2'],
  ...
  {
    id: 13,
    primaryBrdSectionIds: ['5.1', '5', '6', 'doc-meta-1', 'doc-meta-2'],
